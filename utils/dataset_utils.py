...
from sr_datasets.anycam_dataset import AnycamDataset
...
def get_dataset(dataset_name, split_filepath, single_debug_scan_id=None, verbose=True):
    ...
    if dataset_name == "scannet":
        ...
        if verbose:
            print(f"".center(80, "#"))
            print(
                f" Scanniverse Dataset, number of scans: {len(scans)} ".center(80, "#")
            )
            print(f"".center(80, "#"))
            print("")
        ...
        dataset_class = AnycamDataset
        if verbose:
            print(f"".center(80, "#"))
            print(f" Anycam Dataset, number of scans: {len(scans)} ".center(80, "#"))
            print(f"".center(80, "#"))
            print("")
